...
<body>
    <div class="form-container">
        ...
        <div class="form-group">
            ...
            <input type="radio" id="para_criancas" name="indicacao" value="criancas" <?= $indicacao == "Para as crianças" ? 'checked' : '' ?>>
            <label for="para_criancas">Para crianças</label>

            <input type="radio" id="para_todas_idades" name="indicacao" value="todas_idades" <?= $indicacao == "Para todas as idades" ? 'checked' : '' ?> >
            <label for="para_todas_idades">Para todas as idades</label>

            <input type="radio" id="para_adultos" name="indicacao" value="adultos" <?= $indicacao == "Para Adultos" ? 'checked' : '' ?>>
